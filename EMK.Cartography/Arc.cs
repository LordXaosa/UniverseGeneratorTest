...
namespace EMK.Cartography
{
    ...
    public class Arc
    {
        ...
        public Arc(Node Start, Node End) : this(Start, End, 1)
        {
        ...
        {
            if (start == null) throw new ArgumentNullException("StartNode");
            if (end == null) throw new ArgumentNullException("EndNode");
            if (end != null && start.Equals(end) && end.Equals(start)) throw new ArgumentException("StartNode and EndNode must be different");
            if (_StartNode != null && _EndNode!=null)
            {
                _StartNode.OutgoingArcsHash.Remove(this);
                _EndNode.IncomingArcsHash.Remove(this);
            }

            _StartNode = start;
            _EndNode = end;
            _StartNode.OutgoingArcsHash.Add(this);
            _EndNode.IncomingArcsHash.Add(this);
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append(_StartNode.ToString());
            sb.Append("-->");
            sb.Append(_EndNode.ToString());
            return sb.ToString();*/
        ...
        public override int GetHashCode()
        {
            ...
            /*unchecked
            {
                int result = StartNode.GetHashCode()^EndNode.GetHashCode();
                return result;
                int hash = 17;
                // Suitable nullity checks etc, of course :)
                hash = hash * 23 + StartNode.Position.GetHashCode();
                hash = hash * 23 + EndNode.Position.GetHashCode();
                return hash;
            }*/
        }
    }
